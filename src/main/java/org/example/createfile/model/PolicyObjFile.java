...
public class PolicyObjFile {
    ...
    public PolicyObjFile(PolicyObjParser policyObjParser, String nameFile, String companyName, String client, String date, String typeOf, String typeOfPayment, String cuenta_method, String description_methods, List<String> tax_id, List<String> tax_description, int folio) {
        this.policyObj = policyObjParser;
        this.nameFile = nameFile;
        this.companyName = companyName;
        this.client = client;
